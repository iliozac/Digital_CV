...
3. ***Gestione di strutture polifoniche***
  ...
  Per un amante dell'elettronica analogica non si potrebbe immaginare nulla di più affascinante di una semplice tensione variabile da 0-5V (o 0-10V) che viene riconosciuta e interpretata in modo pressochè univoco da un intero universo di circuiti (peraltro molti dei quali ormai basati su tecnologia digitale).
